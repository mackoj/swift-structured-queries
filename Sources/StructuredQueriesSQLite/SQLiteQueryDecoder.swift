...
struct SQLiteQueryDecoder: QueryDecoder {
  ...
  @inlinable
  @inline(__always)
  mutating func decodeColumn(_ columnType: ContiguousArray<UInt8>.Type) throws -> ContiguousArray<UInt8>? {
  ...
  @inlinable
  @inline(__always)
  mutating func decodeColumn(_ columnType: Double.Type) throws -> Double? {
    defer { currentIndex += 1 }
    guard sqlite3_column_type(statement, currentIndex) != SQLITE_NULL else { return nil }
  ...
  @inlinable
  @inline(__always)
  mutating func decodeColumn(_ columnType: Int64.Type) throws -> Int64? {
    defer { currentIndex += 1 }
    guard sqlite3_column_type(statement, currentIndex) != SQLITE_NULL else { return nil }
  ...
  @inlinable
  @inline(__always)
  mutating func decodeColumn(_ columnType: String.Type) throws -> String? {
    defer { currentIndex += 1 }
    guard sqlite3_column_type(statement, currentIndex) != SQLITE_NULL else { return nil }
